# Real Estate Dynamic Website Engine

This is the Next.js consumer property explorer site. It has been aligned with the architecture of your **`healthcare/ui`** and **`amplio-merchant`** codebases using the **Minimal UI Kit** structural organization.
...
│   ├── sections/         # Complex page visual layouts (home-view.tsx)
│   ├── components/       # Reusable UI controls (PremiumButton)
│   ├── layouts/          # Header navigation templates (MainLayout)
