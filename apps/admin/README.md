# Real Estate Super Admin Portal

This is the Next.js Super Admin portal. It has been aligned with the architecture of your **`healthcare/ui`** and **`amplio-merchant`** codebases using the **Minimal UI Kit** structural organization.
...
│   ├── sections/         # Complex page visual layouts (overview-view.tsx)
